...
from cli.ui.renderer.formatting import _validity_score_percent, investigation_llm_progress_hint
from cli.ui.renderer.terminal import _print_connection_banner, _print_info
from cli.ui.renderer.tools import (
    _tool_event_key,
    _tool_input,
    _tool_output,
    _tool_short_label,
